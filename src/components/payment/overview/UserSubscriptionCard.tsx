      ...
      <div className="p-6">
        ...
        {subscription?.payment_method_brand && (
          <div className="mt-4 p-4 bg-gray-50 rounded-lg">
            <div className="text-sm font-medium text-gray-700 mb-2">{t?.paymentMethod || 'Payment Method'}</div>
        ...
        <div className="mt-4 pt-4 border-t border-gray-100">
          {subscription?.subscription_status ? (
            ...
            <div className="text-sm text-gray-600">
              {t?.fullAccess || 'As a superadmin, you have full access to all features without requiring a subscription.'}
            </div>
          ) : (
            <Button
              as={Link}
