...
/**
 * Gift description component with the same design as the gamification contact info component
 */
    ...
    >
      ...
      <span className={cn(
        ...
        <span className="text-sm sm:text-base">
          {translations?.review?.giftDescription || 'Your reward:'} <span className="font-medium">{giftDescription}</span>
        </span>
      </span>
    </motion.div>
  );
