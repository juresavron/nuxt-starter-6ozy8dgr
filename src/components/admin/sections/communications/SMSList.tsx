...
import { MessageSquare, Calendar, CheckCircle, AlertCircle, User, Building2 } from 'lucide-react';
...
/**
 * Component for displaying a list of sent SMS messages
 */
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center p-12">
        ...
        <p className="ml-4 text-gray-600">{t?.loading || 'Loading messages...'}</p>
      </div>
    );
  }
    ...
    return (
      <Card>
        <div className="p-6 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">{t?.noSMS || 'No SMS messages found'}</h3>
          <p className="text-gray-500">
            {t?.noSMSMessage || 'No SMS messages have been sent yet.'}
          </p>
        </div>
      </Card>
    );
            ...
            <div className="p-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">{t?.smsMessage || 'SMS Message'}</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{message.recipient}</p>
                  </div>
                </div>
                ...
                {message.company_name && (
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">{message.company_name}</p>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="border-t border-gray-100 pt-4 mt-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-500">{t?.message || 'Message'}</p>
...
export default React.memo(SMSList);