...
const FeatureCard: React.FC<FeatureCardProps> = ({ 
  ...
  return (
    <motion.div
      ...
      className="bg-white p-5 sm:p-6 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-[1.03] border border-gray-100/80 h-full"
    ...
    >
      ...
      <div className="absolute bottom-0 right-0 w-32 h-32 rounded-tl-full bg-gradient-to-br from-transparent to-blue-50/40 -z-0"></div>
